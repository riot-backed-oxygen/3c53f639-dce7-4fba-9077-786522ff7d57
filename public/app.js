const dateOnly=v=>v?String(v).slice(0,10):v;const state={page:1,limit:12,search:'',sort:'last_seen_at',direction:'desc',age_min:'',age_max:'',height_min:'',height_max:'',bust_min:'',bust_max:'',waist_min:'',waist_max:'',hip_min:'',hip_max:'',cup:''};
...
const advanced=document.createElement('div');advanced.className='advanced';advanced.innerHTML='<span class="adv-label">高级检索</span><input data-k="age_min" type="number" min="0" placeholder="年龄 ≥"><input data-k="age_max" type="number" min="0" placeholder="年龄 ≤"><input data-k="height_min" type="number" min="0" step="1" placeholder="身高 ≥ cm" aria-label="最低身高（厘米）"><input data-k="height_max" type="number" min="0" step="1" placeholder="身高 ≤ cm" aria-label="最高身高（厘米）"><input data-k="bust_min" type="number" min="0" placeholder="胸围 ≥"><input data-k="bust_max" type="number" min="0" placeholder="胸围 ≤"><input data-k="waist_min" type="number" min="0" placeholder="腰围 ≥"><input data-k="waist_max" type="number" min="0" placeholder="腰围 ≤"><input data-k="hip_min" type="number" min="0" placeholder="臀围 ≥"><input data-k="hip_max" type="number" min="0" placeholder="臀围 ≤"><input data-k="cup" placeholder="罩杯，如 C"><button id="applyAdvanced">应用</button>';document.querySelector('.toolbar').after(advanced);
